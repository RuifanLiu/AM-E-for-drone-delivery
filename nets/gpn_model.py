...
class GPNModelFixed(NamedTuple):
    """
    ...
    def __getitem__(self, key):
        ...
        return super(GPNModelFixed, self).__getitem__(key)
...
class GPNModel(nn.Module):
    ...
    def _precompute(self, embeddings, num_steps=1):
        ...
        return GPNModelFixed(embeddings, fixed_context, *fixed_attention_node_data)
