# -*- coding: utf-8 -*-
"""
Created on Mon May 31 14:05:09 2021
...
from utils import run_all_in_pool, load_problem
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--method",default='ortools',help="Name of the method to evaluate, 'compass', 'opga' or 'tsili'")
    # parser.add_argument("--datasets",default=['data/epdp/epdp20_test_seed10.pkl'],nargs='+', help="Filename of the dataset(s) to evaluate")
    parser.add_argument("-f", action='store_true', help="Set true to overwrite")
    parser.add_argument("-o", default=None, help="Name of the results file to write")
    parser.add_argument("-unable_multiprocessing", action='store_false', help="Set false to overwrite")
    ...
    for dataset_path in opts.datasets:
        ...
        if opts.o is None:
            results_dir = os.path.join(opts.results_dir, "epdp", dataset_basename)
            ...
            out_file = os.path.join(results_dir, "{}{}{}-{}-{}{}".format(
                ...
                opts.method, 
                "margin{}".format(opts.battery_margin),ext,
            ))
        else:
            out_file = opts.o
        ...
        if method == "tsili" or method == "tsiligreedy":
            ...
            if method[:6] == "gurobi":
                use_multiprocessing = opts.unable_multiprocessing  # We run one thread per instance
                ...
                def run_func(args):
                    return solve_gurobi(*args, disable_cache=opts.disable_cache,
                                        ...
                                        battery_margin=opts.battery_margin)
            elif method == "compass":
                ...
                use_multiprocessing = opts.unable_multiprocessing

                def run_func(args):
                    return solve_ortools(*args, sec_local_search=runs, disable_cache=opts.disable_cache, battery_margin=opts.battery_margin)
        ...
        print(['Duration:',np.sum(durations)])
